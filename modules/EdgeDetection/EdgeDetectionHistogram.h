...
// Module functions
extern void EdgeDetectionHistogram_run(void);
extern void EdgeDetectionHistogram_start(void);
extern void EdgeDetectionHistogram_stop(void);
